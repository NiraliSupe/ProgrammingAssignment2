...
## It increses the performance ad it saves a lot of time to calculate 
...
makeCacheMatrix <- function(x = matrix()) {
  ...
  getinv <- finction() inverse
  # Return the vector of functions for getting special matrix
  list(set = set, get = get, setinv = setinv, getinv = getinv)
}


## Returns the inverse from cache from a matric created by makeCacheMatrix
...
cacheSolve(m)    ## This call calculate the inverse and store in cache
